...
public class VideoPokerGUI extends JFrame implements ActionListener {
     ...
     *
     * @param seed if -1, a random game is played, otherwise the same game is
     *             played, in that
     *             the deck will be shuffled the same way, whenever the seed is the
     *             same.
     */
     ...
     *
     * @param args args[0] optional seed used for testing which determines how the
     *             deck is shuffled
     */
